...
class DokuUtilRender {
    /* -------------------------------------------------------------------- */
    private static $__MapWb = ['<wb/>' => '', '<wb />' => '', '{{wb}}' => '',];
    /* -------------------------------------------------------------------- */
    public static function XhtmlGet($inMarkup, &$outInfo = [], $inDateAt = '') {
    ...
    /* -------------------------------------------------------------------- */
    /* public static function WikiXhtml($inId, $inRev = '', $inExcuse = true, $inDateAt = '') {
    ...
    /* -------------------------------------------------------------------- */
    /* private static function __p_wiki_xhtml($id, $rev = '', $excuse = true, $date_at = '') {
        $file = wikiFN($id, $rev);
        $ret = '';
